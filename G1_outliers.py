...
parser.add_argument('-win_type', type=str, metavar='window_type', default='geo', help='geographic or snp-based windows')
parser.add_argument('-ms', type=int, metavar='minimum_snps', default='10', help='Minimum number of SNPs in a window [10]')
parser.add_argument('-m', type=float, metavar='missingness_allowed', default='0.1', help='Proportion of missing data allowed in each group')
parser.add_argument('-ws', type=int, metavar='window_size', default='10000', help='Window size in bp [10000]')
